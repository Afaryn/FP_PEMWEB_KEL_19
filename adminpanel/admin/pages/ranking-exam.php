...
<script>
    document.getElementById("exportButton").addEventListener("click", function() {
        // Mengarahkan ke file PHP yang akan mengekspor data ke Excel
        window.location.href = "export_excel.php?exam_id=<?php echo $exam_id; ?>";

        // Menampilkan pemberitahuan setelah ekspor selesai
        setTimeout(function() {
            alert("Export to Excel successful!"); // Menggunakan alert
            // Atau, ubah konten dari elemen HTML dengan ID tertentu
            // document.getElementById("exportStatus").innerHTML = "Export to Excel successful!";
        }, 1000); // Waktu tunda dalam milidetik (misalnya, 1000 = 1 detik)
    });
    document.getElementById("exportpdfButton").addEventListener("click", function() {
        // Mengarahkan ke file PHP yang akan mengekspor data ke Excel
        window.location.href = "export_pdf.php?exam_id=<?php echo $exam_id; ?>";

        // Menampilkan pemberitahuan setelah ekspor selesai
        setTimeout(function() {
            alert("Export to pdf successful!"); // Menggunakan alert
            // Atau, ubah konten dari elemen HTML dengan ID tertentu
            // document.getElementById("exportStatus").innerHTML = "Export to Excel successful!";
        }, 1000); // Waktu tunda dalam milidetik (misalnya, 1000 = 1 detik)
    });
